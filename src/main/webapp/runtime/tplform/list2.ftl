				...
				columnConfig:{
					...
					colunms:[{//列表项
					   ...
					   header: "预览", 	
						...
						width:50+32,	
						dataIndex:'id',	
					   tpl:'<a href="../runtime/template!preview.jhtml?'+paramsStr +'" target="_blank">预览</a>&nbsp;|&nbsp;<a href="../runtime/template!preview2.jhtml?'+paramsStr +'" target="_blank"><span style="margin:0;padding:0;color:#red">new</span></a>'
					},{
						header: "模板可视化编辑",  
						width:96+32,
						align:"center",	
						dataIndex:'id',						
						tpl:'<a href="../runtime/template!design.jhtml?'+paramsStr +'" target="_blank">模板可视化编辑</a>&nbsp;|&nbsp;<a href="../runtime/template!design2.jhtml?'+paramsStr +'" target="_blank"><span style="margin:0;padding:0;color:#red">new</span></a>'
					},{
					   header: "碎片可视化编辑",
					   width:96+32,
						align:"center",		
						dataIndex:'id',
					   tpl:'<a href="../runtime/template!idxEditor.jhtml?'+paramsStr +'" target="_blank">碎片可视化编辑</a>&nbsp;|&nbsp;<a href="../runtime/template!idxEditor2.jhtml?'+paramsStr +'" target="_blank"><span style="margin:0;padding:0;color:#red">new</span></a>'
					},{
					   header: "通栏可视化编辑",
					   width:96+32,
						align:"center",		
						dataIndex:'id',
					   tpl:'<a href="../runtime/template!blockEditor.jhtml?'+paramsStr +'" target="_blank">通栏可视化编辑</a>&nbsp;|&nbsp;<a href="../runtime/template!blockEditor2.jhtml?'+paramsStr +'" target="_blank"><span style="margin:0;padding:0;color:#red">new</span></a>'
					},{
					   header: "编辑",
					   width:50+32,
						align:"center",		
						dataIndex:'id',
					   tpl:'<a href="../runtime/template/index.html?'+paramsStr + '" target="_blank">编辑</a>&nbsp;|&nbsp;<a href="../runtime/template/index2.html?'+paramsStr + '" target="_blank"><span style="margin:0;padding:0;color:#red">new</span></a>'
					}]
				}
			}
		});
