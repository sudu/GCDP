Ext.ns("ifeng");
	...
	buildToolbar: function() {
        ...
        this.tbar = new Ext.Toolbar([{
            ...
            iconCls : 'check',
            tooltip : '添加组用户',
            handler : this.addGroupUser.createDelegate(this)
        },{
            id      : 'settingAnthrity',
            text    : '查看组用户',
            iconCls : 'check',
            tooltip : '查看组用户',
            handler : this.checkGroupUser.createDelegate(this)
    ...
    checkGroupUser : function(){
    	if (!this.dialog) {
	     ...
	     if (this.checkOne()) {
	    	 checkGroupUser(this.getSelections()[0].id);
	     }
    },
    ...
    addGroupUser : function(){
    	if (!this.dialog) {
	     ...
	     if (this.checkOne()) {
	    	 addGroupUser(this.getSelections()[0].id);
	     }
    },
