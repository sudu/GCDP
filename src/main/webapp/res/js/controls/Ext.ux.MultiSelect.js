...
Ext.ux.MultiSelect = Ext.extend(Ext.form.ComboBox, {
	...
	initComponent : function() {
		...
		// call parent
		Ext.ux.MultiSelect.superclass.initComponent.apply(this, arguments);
	...
	,
	initEvents : function() {
		Ext.ux.MultiSelect.superclass.initEvents.apply(this, arguments);
