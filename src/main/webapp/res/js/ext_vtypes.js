/*
*description:Ext.form.VTypes的类型扩展
*author:cici
**/
...
Ext.form.VTypes["ipVal"] = /^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$/;
...
Ext.form.VTypes["ipText"]="请输入合法的IP地址1.0.0.1 - 223.255.255.254";
...
Ext.form.VTypes["portText"]="请输入合法的端口号(0-65535)"
